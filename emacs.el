...
;;;		       ))
  (global-set-key "\C-x\C-i" 'set-basic-offset)
...
;; ZETA Z environment
  ...
  ;; LaTeX mode outlines
  (setq auto-mode-alist (cons '("\\.slide$" . latex-mode) auto-mode-alist))
  (add-hook 'latex-mode-hook
	    (function (lambda () (define-key
			  tex-mode-map
			  "\C-xl"
			  'latex-outline-level))))
